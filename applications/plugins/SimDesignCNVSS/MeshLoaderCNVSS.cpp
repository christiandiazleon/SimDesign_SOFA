...
MeshLoaderCNVSS::MeshLoaderCNVSS() : BaseLoader()
...
void MeshLoaderCNVSS::parse(sofa::core::objectmodel::BaseObjectDescription* arg)
{
...
void MeshLoaderCNVSS::init()
{
    BaseLoader::init();
    this->reinit();
}

void MeshLoaderCNVSS::reinit()
{
...
bool MeshLoaderCNVSS::canLoad()
{
    return BaseLoader::canLoad();
}

void MeshLoaderCNVSS::updateMesh()
{
    updateElements();
    updatePoints();
    updateNormals();
...
void MeshLoaderCNVSS::updateElements()
{
...
void MeshLoaderCNVSS::updatePoints()
{
...
void MeshLoaderCNVSS::updateNormals()
{
...
void MeshLoaderCNVSS::applyTransformation(Matrix4 const& T)
{
    if (!T.isTransform()) {
...
void MeshLoaderCNVSS::addPosition(helper::vector<sofa::defaulttype::Vec<3,SReal> >* pPositions, const sofa::defaulttype::Vec<3,SReal> &p)
{
    pPositions->push_back(p);
}

void MeshLoaderCNVSS::addPosition(helper::vector<sofa::defaulttype::Vec<3,SReal> >* pPositions,  SReal x, SReal y, SReal z)
{
    addPosition(pPositions, sofa::defaulttype::Vec<3,SReal>(x, y, z));
}


void MeshLoaderCNVSS::addEdge(helper::vector<Edge >* pEdges, const Edge &p)
{
    pEdges->push_back(p);
}

void MeshLoaderCNVSS::addEdge(helper::vector<Edge >* pEdges, unsigned int p0, unsigned int p1)
{
    addEdge(pEdges, Edge(p0, p1));
}

void MeshLoaderCNVSS::addTriangle(helper::vector<Triangle >* pTriangles, const Triangle &p)
{
...
void MeshLoaderCNVSS::addTriangle(helper::vector<Triangle >* pTriangles, unsigned int p0, unsigned int p1, unsigned int p2)
{
    addTriangle(pTriangles, Triangle(p0, p1, p2));
}

void MeshLoaderCNVSS::addQuad(helper::vector<Quad >* pQuads, const Quad &p)
{
    if (d_flipNormals.getValue())
    {
        Quad revertP;
...
void MeshLoaderCNVSS::addQuad(helper::vector<Quad >* pQuads, unsigned int p0, unsigned int p1, unsigned int p2, unsigned int p3)
{
    addQuad(pQuads, Quad(p0, p1, p2, p3));
}

void MeshLoaderCNVSS::addPolygon(helper::vector< helper::vector <unsigned int> >* pPolygons, const helper::vector<unsigned int> &p)
{
    if (d_flipNormals.getValue())
    {
...
void MeshLoaderCNVSS::addTetrahedron(helper::vector< Tetrahedron >* pTetrahedra, const Tetrahedron &p)
{
    pTetrahedra->push_back(p);
}

void MeshLoaderCNVSS::addTetrahedron(helper::vector< Tetrahedron >* pTetrahedra, unsigned int p0, unsigned int p1, unsigned int p2, unsigned int p3)
{
    addTetrahedron(pTetrahedra, Tetrahedron(p0, p1, p2, p3));
}

void MeshLoaderCNVSS::addHexahedron(helper::vector< Hexahedron >* pHexahedra,
...
void MeshLoaderCNVSS::addHexahedron(helper::vector< Hexahedron >* pHexahedra, const Hexahedron &p)
{
    pHexahedra->push_back(p);
}

void MeshLoaderCNVSS::addPentahedron(helper::vector< Pentahedron >* pPentahedra,
        unsigned int p0, unsigned int p1, unsigned int p2, unsigned int p3,
...
void MeshLoaderCNVSS::addPentahedron(helper::vector< Pentahedron >* pPentahedra, const Pentahedron &p)
{
    pPentahedra->push_back(p);
}

void MeshLoaderCNVSS::addPyramid(helper::vector< Pyramid >* pPyramids,
...
void MeshLoaderCNVSS::addPyramid(helper::vector< Pyramid >* pPyramids, const Pyramid &p)
{
