...
******************************************************************************/
#ifndef SOFA_CORE_LOADER_MESHLOADERCNVSS_H
#define SOFA_CORE_LOADER_MESHLOADERCNVSS_H
...
class SOFA_CORE_API MeshLoaderCNVSS : public BaseLoader
{
public:
    SOFA_ABSTRACT_CLASS(MeshLoaderCNVSS, BaseLoader);
...
public:
    ...
    /*void setFilename(std::string f)
  	{
  		m_filenames.resize(indexCurrentMesh.getValue()+1);

  		m_filenames[indexCurrentMesh.getValue()].setValue(f);
  	}

    const std::string &getFilename() const
  	{
  		return m_filenames[indexCurrentMesh.getValue()].getValue();
  	}*/
