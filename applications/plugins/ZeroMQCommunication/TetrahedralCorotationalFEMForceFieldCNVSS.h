...
******************************************************************************/
#ifndef SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALCOROTATIONALFEMFORCEFIELDCNVSS_H
#define SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALCOROTATIONALFEMFORCEFIELDCNVSS_H
...
class TetrahedralCorotationalFEMForceFieldCNVSS : public core::behavior::ForceField<DataTypes>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE(TetrahedralCorotationalFEMForceFieldCNVSS, DataTypes), SOFA_TEMPLATE(core::behavior::ForceField, DataTypes));
...
public:
    ...
    {
    public :
        typedef typename TetrahedralCorotationalFEMForceFieldCNVSS<DataTypes>::TetrahedronInformation TetrahedronInformation;
        TetrahedronHandler(TetrahedralCorotationalFEMForceFieldCNVSS<DataTypes>* ff,
    ...
    protected:
        TetrahedralCorotationalFEMForceFieldCNVSS<DataTypes>* ff;
...
public:
    ...
    Data<bool> IsCarvinable;
    Data<bool> IsClipAttachable;
    Data<bool> IsCFEM;
    Data<bool> IsServer;
    Data<bool> IsLocal;
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_ZeroMQCommunication_API_TETRAHEDRALCOROTATIONALFEMFORCEFIELDCNVSS_CPP)

/*#ifndef SOFA_FLOAT
extern template class SOFA_GENERAL_SIMPLE_FEM_API TetrahedralCorotationalFEMForceFieldCNVSS<sofa::defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_GENERAL_SIMPLE_FEM_API TetrahedralCorotationalFEMForceFieldCNVSS<sofa::defaulttype::Vec3fTypes>;
#endif*/

#ifndef SOFA_FLOAT
extern template class SOFA_ZeroMQCommunication_API TetrahedralCorotationalFEMForceFieldCNVSS<sofa::defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_ZeroMQCommunication_API TetrahedralCorotationalFEMForceFieldCNVSS<sofa::defaulttype::Vec3fTypes>;
#endif

#endif // defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALCOROTATIONALFEMFORCEFIELDCNVSS_CPP)
...
#endif // SOFA_COMPONENT_FORCEFIELD_TETRAHEDRALCOROTATIONALFEMFORCEFIELDCNVSS_H
